...
3. Add error messages to `src/backend/Netrock.Shared/ErrorMessages.cs`
...
5. Add `DbSet<{Entity}>` to `Infrastructure/Persistence/NetrockDbContext.cs`
6. Run migration:
   ```bash
...
7. `dotnet build src/backend/Netrock.slnx` — fix errors, loop until green

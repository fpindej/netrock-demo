...
export interface paths {
	...
	'/api/v1/contacts/seed': {
		...
		post: {
			parameters: {
				query?: {
					/** @description Number of contacts to generate (1–50, default 10). */
					count?: number;
				};
				header?: never;
				path?: never;
			...
			requestBody?: never;
			responses: {
				/** @description Sample contacts created successfully. */
				201: {
					headers: {
						[name: string]: unknown;
					};
				...
				/** @description If the user already has contacts. */
				400: {
					headers: {
						[name: string]: unknown;
					};

...
using Netrock.Infrastructure.Features.Jobs.Examples;
using Netrock.Infrastructure.Features.Jobs.Options;
using Netrock.Infrastructure.Features.Jobs.RecurringJobs;
...
public static class ServiceCollectionExtensions
{
    extension(IServiceCollection services)
    {
        ...
        public IServiceCollection AddJobScheduling(IConfiguration configuration)
        {
            ...
            services.AddScoped<ExpiredDemoAccountCleanupJob>();
            services.AddScoped<IRecurringJobDefinition>(sp =>
                sp.GetRequiredService<ExpiredDemoAccountCleanupJob>());

            services.AddScoped<ExpiredJobExecutionCleanupJob>();
            services.AddScoped<IRecurringJobDefinition>(sp =>
                sp.GetRequiredService<ExpiredJobExecutionCleanupJob>());

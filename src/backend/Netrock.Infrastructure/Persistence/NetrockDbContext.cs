...
namespace Netrock.Infrastructure.Persistence;
...
/// </summary>
internal class NetrockDbContext(DbContextOptions<NetrockDbContext> options)
    : IdentityDbContext<ApplicationUser, ApplicationRole, Guid>(options)
{
    ...
    /// See <see cref="Netrock.Application.Identity.Constants.AppRoles"/>.
    /// </para>
    /// </summary>
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        base.OnModelCreating(modelBuilder);
        modelBuilder.ApplyConfigurationsFromAssembly(typeof(NetrockDbContext).Assembly);

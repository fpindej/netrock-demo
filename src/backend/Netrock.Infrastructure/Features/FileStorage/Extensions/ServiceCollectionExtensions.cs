...
using Netrock.Infrastructure.Features.FileStorage.Options;
using Netrock.Infrastructure.Features.FileStorage.Services;

namespace Netrock.Infrastructure.Features.FileStorage.Extensions;
